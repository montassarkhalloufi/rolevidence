...
- Keep the model behind the application port. The product analysis has no tool access. Do not introduce agent frameworks, RAG, tools or automatic paid retries.
