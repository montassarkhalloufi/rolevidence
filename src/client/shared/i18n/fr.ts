export const fr = {
  ...
  possibleCompatibility: "Budget à confirmer",
  declaredEducationGap: "Écart sur le diplôme présenté",
  negotiablePreference: "Souhait négociable",
  partialEvidence: "Indice documenté · à préciser",
  salaryPriority: "Importance du salaire souhaité",
  workModePriority: "Importance du mode et des jours de télétravail",
  requiredPreference: "Contrainte obligatoire",
  preferredPreference: "Souhait négociable",
