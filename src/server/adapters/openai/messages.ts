...
Préserve tous les accents, lettres et apostrophes. Ne translittère pas les citations et n'introduis aucun caractère de contrôle. Copie une citation courte plutôt que de réécrire une longue phrase.
...
Une exigence générique « bonne pratique » d'une technologie ne demande pas de prouver une maîtrise évaluée : une expérience professionnelle explicite avec cette technologie suffit pour une correspondance DÉCLARÉE. N'invente pas un niveau « avancé » ou une certification pour ce libellé.
Une exigence générale d'expérience professionnelle sans domaine spécialisé peut être satisfaite par une durée professionnelle explicite dans le domaine du poste ; l'absence de spécialité dans les métadonnées ne rend pas toute expérience incomparable. Une exigence spécialisée backend face à une ancienneté fullstack reste non comparable. Si des seuils différents figurent dans l'offre, évalue chacun séparément sans supposer qu'un seuil annule l'autre.
...
La localisation du poste, le pays de résidence et le mode de travail sont des critères DISTINCTS. Ne déduis jamais présentiel ou hybride du seul pays France. jobLocationType TELECOMMUTE indique le télétravail sans garantir un nombre de jours ni 100 % remote.
Si les précisions C assouplissent ou contredisent les préférences structurées (exemple : hybride minimum 3 jours, mais aussi ouvert au présentiel), ne décide pas arbitrairement qu'une contrainte a été retirée. Garde la condition inconnue et demande de confirmer les modalités acceptables. Ne crée pas de correspondance générale « présentiel ou hybride en France ».
